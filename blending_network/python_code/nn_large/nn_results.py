...
for i in range(len(n_train)):
    ...
    for n_instance in range(10):
        ...
        nn = Sequential(name='relu_7_25')
        nn.add(Dense(units=25, input_dim=3, activation='relu'))
    ...
    plt.savefig('nn_large/loss_' + str(n_train[i]) + '_' + str(n_params) + '.png')
    plt.close('all')

with open('nn_large/E2E_' + str(n_params) + '.pickle', 'wb') as file:
